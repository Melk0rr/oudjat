...
class SentinelOneEndpointFormatError(ValueError):
    """
    A helper error class to handle S1 endpoint formatting errors.
    """

    def __init__(self, message: str) -> None:
        """
        Create a new instance of SentinelOneEndpointFormatError.
