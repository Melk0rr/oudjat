...
class LDAPAccountCtlFlag(BitFlag):
    ...
    def is_disabled(account_control: int) -> bool:
        ...
        return LDAPAccountCtlFlag.check_flag(account_control, LDAPAccountCtlFlag.ACCOUNT_DISABLE) != 0
    ...
    def pwd_expires(account_control: int) -> bool:
        ...
        return not LDAPAccountCtlFlag.check_flag(account_control, LDAPAccountCtlFlag.PASSWD_DONT_EXPIRE)
    ...
    def pwd_expired(account_control: int) -> bool:
        ...
        return LDAPAccountCtlFlag.check_flag(account_control, LDAPAccountCtlFlag.PASSWORD_EXPIRED) != 0
    ...
    def pwd_required(account_control: int) -> bool:
        ...
        return not LDAPAccountCtlFlag.check_flag(account_control, LDAPAccountCtlFlag.PASSWD_NOTREQD)
    ...
    def is_locked(account_control: int) -> bool:
        ...
        return not LDAPAccountCtlFlag.check_flag(account_control, LDAPAccountCtlFlag.LOCKOUT)
